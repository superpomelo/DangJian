...
- (NSArray *)viewControllersForTabBar {
    LaborCenterHomeViewController *firstViewController = [[LaborCenterHomeViewController alloc] init];
    UIViewController *firstNavigationController = [[CYLBaseNavigationController alloc]
                                                   initWithRootViewController:firstViewController];
    [firstViewController cyl_setHideNavigationBarSeparator:YES];
    // [firstViewController cyl_setNavigationBarHidden:YES];
    LearningCenterHomeViewController *secondViewController = [[LearningCenterHomeViewController alloc] init];
    ...
    MyCircleCenterHomeViewController *thirdViewController = [[MyCircleCenterHomeViewController alloc] init];
    ...
    PersonalCenterHomeViewController *fourthViewController = [[PersonalCenterHomeViewController alloc] init];
...
- (NSArray *)tabBarItemsAttributesForTabBar {
    ...
    NSDictionary *firstTabBarItemsAttributes = @{
                                                 ...
                                                 CYLTabBarItemImage : [UIImage imageNamed:@"联合 2"],  /* NSString and UIImage are supported*/
                                                 CYLTabBarItemSelectedImage : @"联合 2",  /* NSString and UIImage are supported*/
                                                 CYLTabBarItemTitlePositionAdjustment: [NSValue valueWithUIOffset:UIOffsetMake(firstXOffset, -3.5)],
                                                 //第一位 右大，下大
                                                 CYLTabBarLottieURL : [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"合成1" ofType:@"json"]],
...
//                                                 CYLTabBarLottieSize: [NSValue valueWithCGSize:CGSizeMake(22, 22)]
    ...
    NSDictionary *secondTabBarItemsAttributes = @{
                                                  ...
                                                  CYLTabBarLottieURL : [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"合成 2" ofType:@"json"]],
//                                                  CYLTabBarLottieSize: [NSValue valueWithCGSize:CGSizeMake(33, 33)]
    ...
    NSDictionary *thirdTabBarItemsAttributes = @{
                                                 ...
                                                 CYLTabBarItemSelectedImage : @"联合 2",
                                                 CYLTabBarItemTitlePositionAdjustment: [NSValue valueWithUIOffset:UIOffsetMake(-secondXOffset, -3.5)],
                                                 CYLTabBarLottieURL : [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"合成 3" ofType:@"json"]],
//                                                 CYLTabBarLottieSize: [NSValue valueWithCGSize:CGSizeMake(44, 44)]
    ...
    NSDictionary *fourthTabBarItemsAttributes = @{
                                                  ...
                                                  CYLTabBarItemSelectedImage : @"联合 2",
                                                  CYLTabBarItemTitlePositionAdjustment: [NSValue valueWithUIOffset:UIOffsetMake(-firstXOffset, -3.5)],
                                                  CYLTabBarLottieURL : [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"合成 4" ofType:@"json"]],
//                                                  CYLTabBarLottieSize: [NSValue valueWithCGSize:CGSizeMake(22, 22)]
                                                  };
...
//    [UITabBar appearance].translucent = YES;
    ...
    if (@available(iOS 13.0, *)) {
        ...
        //tabbar上面线条颜色
        standardAppearance.shadowColor = [UIColor colorWithRed:235/255.0 green:235/255.0 blue:235/255.0 alpha:1];
        ...
        //tabbar上面线条颜色
        [[UITabBar appearance] setShadowImage:[[self class] imageWithColor:[UIColor colorWithRed:235/255.0 green:235/255.0 blue:235/255.0 alpha:1] size:CGSizeMake([UIScreen mainScreen].bounds.size.width, 0.5)]];
    }
}
