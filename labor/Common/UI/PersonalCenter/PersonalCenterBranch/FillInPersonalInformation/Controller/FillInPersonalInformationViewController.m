//
//  FillInPersonalInformationViewController.m
//  labor
//
...
@interface FillInPersonalInformationViewController ()
...
@implementation FillInPersonalInformationViewController
...
- (void)initUI{
    ...
    self.leftLabel.attributedText = [UILabel getABTbody:@"姓名" font:16 color:SL_UIColorFromHex(333333, 1) zitistyle:@"Source Han Serif CN"];
...
//    para[@"avatar"] = self.model.avatar;
    ...
    para[@"realName"] = self.myTextField.text;
