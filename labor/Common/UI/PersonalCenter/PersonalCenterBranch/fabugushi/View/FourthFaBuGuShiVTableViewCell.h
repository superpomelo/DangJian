//
//  FourthFaBuGuShiVTableViewCell.h
//  labor
//
...
@class FourthFaBuGuShiVTableViewCell;
@protocol FourthFaBuGuShiVTableViewCellDelegate <NSObject>
/**点击图片*/
...
@end
@interface FourthFaBuGuShiVTableViewCell : UITableViewCell
...
@property (nonatomic,weak) id<FourthFaBuGuShiVTableViewCellDelegate>delegate;
