...
@interface PerfectSchoolViewController ()<UIPickerViewDelegate,UIPickerViewDataSource>
...
@property (nonatomic,strong)SchoolNameModel *modelTemp;

@end

@implementation PerfectSchoolViewController
