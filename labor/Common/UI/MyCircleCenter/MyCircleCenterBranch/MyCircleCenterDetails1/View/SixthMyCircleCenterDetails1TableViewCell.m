//
//  SixthMyCircleCenterDetails1TableViewCell.m
//  labor
//
...
@implementation SixthMyCircleCenterDetails1TableViewCell
...
- (IBAction)button1Action:(id)sender {
    if ([self.delegate respondsToSelector:@selector(SixthMyCircleCenterDetails1TableViewCellActiondelegate:location:)]) {
        [self.delegate SixthMyCircleCenterDetails1TableViewCellActiondelegate:self location:0];
    }
}
- (IBAction)button2Action:(id)sender {
    if ([self.delegate respondsToSelector:@selector(SixthMyCircleCenterDetails1TableViewCellActiondelegate:location:)]) {
        [self.delegate SixthMyCircleCenterDetails1TableViewCellActiondelegate:self location:1];
    }
}
- (IBAction)button3Action:(id)sender {
    if ([self.delegate respondsToSelector:@selector(SixthMyCircleCenterDetails1TableViewCellActiondelegate:location:)]) {
        [self.delegate SixthMyCircleCenterDetails1TableViewCellActiondelegate:self location:2];
    }
}
- (IBAction)button4Action:(id)sender {
    if ([self.delegate respondsToSelector:@selector(SixthMyCircleCenterDetails1TableViewCellActiondelegate:location:)]) {
        [self.delegate SixthMyCircleCenterDetails1TableViewCellActiondelegate:self location:3];
    }
}
- (IBAction)button5Action:(id)sender {
    if ([self.delegate respondsToSelector:@selector(SixthMyCircleCenterDetails1TableViewCellActiondelegate:location:)]) {
        [self.delegate SixthMyCircleCenterDetails1TableViewCellActiondelegate:self location:4];
    }
}
- (IBAction)button6Action:(id)sender {
    if ([self.delegate respondsToSelector:@selector(SixthMyCircleCenterDetails1TableViewCellActiondelegate:location:)]) {
        [self.delegate SixthMyCircleCenterDetails1TableViewCellActiondelegate:self location:5];
    }
}
- (IBAction)button7Action:(id)sender {
    if ([self.delegate respondsToSelector:@selector(SixthMyCircleCenterDetails1TableViewCellActiondelegate:location:)]) {
        [self.delegate SixthMyCircleCenterDetails1TableViewCellActiondelegate:self location:6];
    }
}
- (IBAction)button8Action:(id)sender {
    if ([self.delegate respondsToSelector:@selector(SixthMyCircleCenterDetails1TableViewCellActiondelegate:location:)]) {
        [self.delegate SixthMyCircleCenterDetails1TableViewCellActiondelegate:self location:7];
    }
}
- (IBAction)button9Action:(id)sender {
    if ([self.delegate respondsToSelector:@selector(SixthMyCircleCenterDetails1TableViewCellActiondelegate:location:)]) {
        [self.delegate SixthMyCircleCenterDetails1TableViewCellActiondelegate:self location:8];
    }
}
