//
//  SecondNewCirclesTextAndPicTableViewCell.h
//  labor
//
...
@class SecondNewCirclesTextAndPicTableViewCell;
@protocol SecondNewCirclesTextAndPicTableViewCellDelegate <NSObject>
/**点击图片*/
...
@end
@interface SecondNewCirclesTextAndPicTableViewCell : UITableViewCell
...
@property (nonatomic,weak) id<SecondNewCirclesTextAndPicTableViewCellDelegate>delegate;
