//
//  ThirdMyCircleCenterHomeTableViewCell.m
//  labor
//
...
@implementation ThirdMyCircleCenterHomeTableViewCell
...
- (IBAction)shoucangButtonAction:(UIButton*)sender {
    ...
    /**Tag 1收藏，2评论，3转发，4点赞*/
    if ([self.delegate respondsToSelector:@selector(ThirdMyCircleCenterHomeTableViewCellButtonActiondelegate:indexpath:Tag:)]) {
        [self.delegate ThirdMyCircleCenterHomeTableViewCellButtonActiondelegate:self indexpath:self.indexPath Tag:1];
    }
}
/**评论*/
- (IBAction)pinlunButtonAction:(UIButton*)sender {
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(2 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
      ...
      /**Tag 1收藏，2评论，3转发，4点赞*/
    if ([self.delegate respondsToSelector:@selector(ThirdMyCircleCenterHomeTableViewCellButtonActiondelegate:indexpath:Tag:)]) {
        [self.delegate ThirdMyCircleCenterHomeTableViewCellButtonActiondelegate:self indexpath:self.indexPath Tag:2];
    }
}
/**转发*/
- (IBAction)zhuanfaButtonAction:(UIButton*)sender {
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(2 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
      ...
      /**Tag 1收藏，2评论，3转发，4点赞*/
    if ([self.delegate respondsToSelector:@selector(ThirdMyCircleCenterHomeTableViewCellButtonActiondelegate:indexpath:Tag:)]) {
        [self.delegate ThirdMyCircleCenterHomeTableViewCellButtonActiondelegate:self indexpath:self.indexPath Tag:3];
    }
}
/**点赞*/
- (IBAction)dianzanButtonAction:(UIButton*)sender {
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(2 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
      ...
      /**Tag 1收藏，2评论，3转发，4点赞*/
    if ([self.delegate respondsToSelector:@selector(ThirdMyCircleCenterHomeTableViewCellButtonActiondelegate:indexpath:Tag:)]) {
        [self.delegate ThirdMyCircleCenterHomeTableViewCellButtonActiondelegate:self indexpath:self.indexPath Tag:4];
    }
}
